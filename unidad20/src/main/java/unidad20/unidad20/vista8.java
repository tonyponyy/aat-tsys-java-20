...
public class vista8 extends JFrame {
	...
	public vista8() {
		...
		btnNewButton.setBounds(315, 7, 89, 23);
		...
		btnBorrar.setBounds(315, 29, 89, 23);
		btnBorrar.addActionListener(funcion_borrar);
	...
	ActionListener funcion_borrar = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			borrar();
		}
	};
	...
	private void calcular() {
		 try {
		        ...
		        textField_1.setText(Math.round(cantidad*100.0)/100.0 +" "+simbolo);
		    	 ...
		    	 JOptionPane.showMessageDialog(null, "Pon valores validos");
		    }
